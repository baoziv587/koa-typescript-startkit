...
/**
 * Type definitions  for koa-json
 */
declare module KoaJson {
  export interface JsonOptions {
    pretty: boolean
  }

  export function json(option: JsonOptions): any
}
...
/**
 * Type definitions  for koa-compress
 */
declare module KoaCompress {
  ...
  export  function compress(CompressOptions?: CompressOptions): any
}

declare module 'koa-compress' {
  export =KoaCompress.compress;
}
